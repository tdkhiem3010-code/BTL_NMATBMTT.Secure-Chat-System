...
\newcommand{\TenSinhVienA}{TRẦN ĐÌNH KHIÊM}
\newcommand{\MaSinhVienA}{1871020334}

\newcommand{\TenSinhVienB}{lA VĂN HẢI}
\newcommand{\MaSinhVienB}{1871020215}

\newcommand{\TenSinhVien}{\TenSinhVienA}
\newcommand{\MaSinhVien}{\MaSinhVienA}

\newcommand{\TenSinhVienC}{LƯƠNG NHƯ Ý}
\newcommand{\MaSinhVienC}{1871020680}

\newcommand{\TenSinhVienD}{TRƯƠNG VĂN BAN}
\newcommand{\MaSinhVienD}{1871020070}

\newcommand{\KhoaHoc}{K18}

\newcommand{\TenBaoCao}{SECURE CHAT SYSTEM WITH CRYPTOGRAPHIC SECURITY}
\newcommand{\LoaiBaoCao}{BÁO CÁO THỰC TẬP TỐT NGHIỆP}
\newcommand{\Nganh}{CÔNG NGHỆ THÔNG TIN}
\newcommand{\ChuyenNganh}{CÔNG NGHỆ PHẦN MỀM}
