...
Về mặt chức năng, hệ thống đã đáp ứng được các nhu cầu cơ bản của một ứng dụng nhắn tin bảo mật, bao gồm đăng ký, đăng nhập, trao đổi tin nhắn, quản lý phiên làm việc và hiển thị thông tin bảo mật của từng gói tin. Về mặt bảo mật, các cơ chế phát hiện và ngăn chặn tấn công đã được tích hợp và kiểm thử với nhiều kịch bản khác nhau. Về mặt học thuật, đề tài cũng giúp nhóm củng cố được kiến thức về mật mã học, an toàn thông tin và phát triển hệ thống mạng. Đây là nền tảng tốt để tiếp tục nâng cấp hệ thống trong các nghiên cứu hoặc dự án thực tế tiếp theo.
